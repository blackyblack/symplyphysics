...
from symplyphysics.reorganized.circuits.transient_analysis.serial_resistor_capacitor_circuit import voltage_across_charging_capacitor_in_serial_resistor_capacitor_circuit as rc_node
