...
from symplyphysics.reorganized.circuits.alternating_current.admittance import admittance_in_parallel_connection as parallel_admittance_law
from symplyphysics.reorganized.circuits.alternating_current.admittance import admittance_is_inverse_impedance as admittance_def
from symplyphysics.reorganized.circuits.components.capacitors import capacitor_impedance_from_capacitance_and_frequency as capacitor_impedance
from symplyphysics.reorganized.circuits.components.inductors import coil_impedance_via_inductance_and_frequency as coil_impedance
from symplyphysics.reorganized.circuits.transient_analysis.serial_inductor_capacitor_circuit import oscillation_period_of_inductor_capacitor_network as thomsons_formula
