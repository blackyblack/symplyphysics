...
from symplyphysics.laws.thermodynamics import adiabatic_process_equation_via_pressure_and_volume as adiabatic_law
...
solved_adiabatic_law = solve(adiabatic_law.law,
    ...
    dict=True)[0][adiabatic_law.final_pressure]
...
solved_adiabatic_volume_law = solve(adiabatic_law.law,
    ...
    dict=True)[0][adiabatic_law.final_volume]
