...
temperature_end = symbols("temperature_end")
...
for bath_volume in bath_volumes:
    ...
    temperature_supremum = solve(mass_of_ice_equation_to_subplot.subs({mass_of_ice: 0}), temperature_end,
        dict=True)[0][temperature_end]

    subplot = plot(mass_of_ice_equation_to_subplot.rhs, (temperature_end, 280, temperature_supremum),
