...
from symplyphysics.laws.special_relativity.relativistic_kinematics.lorentz_transformation import lorentz_transformation_of_coordinate as transform_law
