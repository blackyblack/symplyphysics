...
from symplyphysics.continuum_mechanics.fluid_mechanics.transport_properties.diffusion import diffusion_flux_from_diffusion_coefficient_and_concentration_gradient as diffusion_flux
