...
from symplyphysics.optics.wave_optics.interference.optical_distances import optical_distance_difference_from_optical_distances as optical_difference_law
