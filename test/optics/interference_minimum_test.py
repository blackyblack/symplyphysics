...
def test_basic_travel_difference(test_args):
    result = minimum_law.calculate_travel_difference(test_args.wave_length, test_args.maximum_number)
...
def test_bad_wave_length(test_args):
    ...
    with raises(errors.UnitsError):
        minimum_law.calculate_travel_difference(lb, test_args.maximum_number)
    with raises(TypeError):
        minimum_law.calculate_travel_difference(100, test_args.maximum_number)
