...
from symplyphysics.laws.optics import \
    interference_from_two_holes as interference_two_holes_law
...
def test_basic_travel_difference(test_args):
    result = interference_two_holes_law.calculate_travel_difference(test_args.x, test_args.d, test_args.l)
