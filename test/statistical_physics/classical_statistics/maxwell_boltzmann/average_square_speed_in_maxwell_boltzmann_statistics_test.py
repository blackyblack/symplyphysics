...
from symplyphysics.statistical_physics.classical_statistics.maxwell_boltzmann import average_square_speed_in_maxwell_boltzmann_statistics as velocity_law
