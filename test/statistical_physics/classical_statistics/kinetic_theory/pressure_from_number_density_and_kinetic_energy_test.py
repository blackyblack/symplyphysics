...
from symplyphysics.statistical_physics.classical_statistics.kinetic_theory import pressure_from_number_density_and_kinetic_energy as ideal_gas_pressure
