...
from symplyphysics.electromagnetism.electrodynamics.maxwell_equations import derivative_of_magnetic_induction_in_time_is_rotor_of_electric_intensity as faradays_law
