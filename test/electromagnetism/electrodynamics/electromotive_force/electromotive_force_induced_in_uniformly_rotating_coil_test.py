...
from symplyphysics.electromagnetism.electrodynamics.electromotive_force import electromotive_force_induced_in_uniformly_rotating_coil as electromotive_force_law
