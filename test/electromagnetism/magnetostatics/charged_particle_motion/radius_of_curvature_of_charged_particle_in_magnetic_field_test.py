...
from symplyphysics.electromagnetism.magnetostatics.charged_particle_motion import radius_of_curvature_of_charged_particle_in_magnetic_field as radius_law
