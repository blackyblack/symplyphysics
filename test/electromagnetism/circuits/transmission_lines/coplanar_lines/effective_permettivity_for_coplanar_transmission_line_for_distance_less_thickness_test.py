...
from symplyphysics.electromagnetism.circuits.transmission_lines.coplanar_lines import effective_permettivity_for_coplanar_transmission_line_for_distance_less_thickness as permittivity_law
