...
from symplyphysics.electromagnetism.circuits.transmission_lines.microstrip_lines import effective_permittivity_for_microstrip_line_for_width_greater_thickness as permittivity_law
