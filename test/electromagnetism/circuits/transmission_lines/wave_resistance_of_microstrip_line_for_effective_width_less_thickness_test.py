...
from symplyphysics.electromagnetism.circuits.transmission_lines import wave_resistance_of_microstrip_line_for_effective_width_less_thickness as resistance_law
