...
from symplyphysics.electromagnetism.circuits.transmission_lines import ratio_of_average_power_to_incident_power_from_reflection_coefficient as coefficient_law
