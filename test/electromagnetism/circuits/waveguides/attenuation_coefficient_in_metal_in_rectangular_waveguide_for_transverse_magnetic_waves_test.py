...
from symplyphysics.electromagnetism.circuits.waveguides import attenuation_coefficient_in_metal_in_rectangular_waveguide_for_transverse_magnetic_waves as coefficient_law
