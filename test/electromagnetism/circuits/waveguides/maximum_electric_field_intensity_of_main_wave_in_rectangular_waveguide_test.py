...
from symplyphysics.electromagnetism.circuits.waveguides import maximum_electric_field_intensity_of_main_wave_in_rectangular_waveguide as intensity_law
