...
from symplyphysics.electromagnetism.circuits.waveguides import characteristic_resistance_of_rectangular_waveguide_for_transverse_magnetic_waves as resistance_law
