...
from symplyphysics.electromagnetism.circuits.waveguides import specific_resistance_of_coaxial_waveguide as resistance_law
...
def test_bad_absolute_permeability(test_args: Args) -> None:
    ...
    with raises(TypeError):
        resistance_law.calculate_specific_resistance(100, test_args.angular_frequency,
