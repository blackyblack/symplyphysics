...
from symplyphysics.electromagnetism.circuits.components.couplers import transient_attenuation_of_separate_loop_coupler_with_cascade_connection as attenuation_law
