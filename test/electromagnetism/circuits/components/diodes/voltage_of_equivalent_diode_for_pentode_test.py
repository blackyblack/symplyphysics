...
from symplyphysics.electromagnetism.circuits.components.diodes import voltage_of_equivalent_diode_for_pentode as voltage_law
...
Args = namedtuple("Args", [
    "voltage_of_first_grid", "voltage_of_second_grid", "voltage_of_third_grid", "anode_voltage",
...
def test_basic_voltage_of_equivalent_diode(test_args: Args) -> None:
    result = voltage_law.calculate_voltage_of_equivalent_diode(
        ...
        test_args.voltage_of_third_grid, test_args.anode_voltage,
        test_args.coefficient_direct_permeability_of_first_grid,
        test_args.coefficient_direct_permeability_of_second_grid,
        test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
...
def test_bad_voltages(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            bad_voltage, test_args.voltage_of_second_grid, test_args.voltage_of_third_grid,
    ...
    with raises(TypeError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            100, test_args.voltage_of_second_grid, test_args.voltage_of_third_grid,
            test_args.anode_voltage, test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, bad_voltage, test_args.voltage_of_third_grid,
            test_args.anode_voltage, test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
    with raises(TypeError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, 100, test_args.voltage_of_third_grid,
            test_args.anode_voltage, test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, test_args.voltage_of_second_grid, bad_voltage,
            test_args.anode_voltage, test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
    ...
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, test_args.voltage_of_second_grid,
            test_args.voltage_of_third_grid, bad_voltage,
            test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
    with raises(TypeError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, test_args.voltage_of_second_grid,
            test_args.voltage_of_third_grid, 100,
            test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
...
def test_bad_coefficients_direct_permeability_of_grids(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, test_args.voltage_of_second_grid,
            test_args.voltage_of_third_grid, test_args.anode_voltage,
            bad_coefficient_direct_permeability_of_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
    with raises(errors.UnitsError):
    ...
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            ...
            test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            bad_coefficient_direct_permeability_of_grid, test_args.distance_to_anode,
            test_args.distance_to_first_grid)
...
def test_bad_distances(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            ...
            test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, bad_distance,
            test_args.distance_to_first_grid)
    with raises(TypeError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, test_args.voltage_of_second_grid,
            ...
            test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid, 100,
            test_args.distance_to_first_grid)
    with raises(errors.UnitsError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            test_args.voltage_of_first_grid, test_args.voltage_of_second_grid,
    ...
    with raises(ValueError):
        voltage_law.calculate_voltage_of_equivalent_diode(
            ...
            test_args.coefficient_direct_permeability_of_first_grid,
            test_args.coefficient_direct_permeability_of_second_grid,
            test_args.coefficient_direct_permeability_of_third_grid,
