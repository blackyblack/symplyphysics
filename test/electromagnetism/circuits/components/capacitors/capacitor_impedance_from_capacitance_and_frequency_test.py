...
from symplyphysics.electromagnetism.circuits.components.capacitors import capacitor_impedance_from_capacitance_and_frequency as capacitor_impedance_law
