...
from symplyphysics.electromagnetism.circuits.components.filters import low_pass_chebyshev_filter_order_from_distortion_and_frequencies as order_law
...
def test_basic_low_pass_chebyshev_filter_order(test_args: Args) -> None:
    result = order_law.calculate_low_pass_chebyshev_filter_order(test_args.bandwidth_distortion,
...
def test_bad_distortions(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        order_law.calculate_low_pass_chebyshev_filter_order(bad_distortion,
            test_args.band_stop_distortion, test_args.band_stop_frequency,
            test_args.cutoff_frequency)
    with raises(errors.UnitsError):
        order_law.calculate_low_pass_chebyshev_filter_order(test_args.bandwidth_distortion,
