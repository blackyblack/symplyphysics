...
from symplyphysics.electromagnetism.circuits.components.filters import approximation_of_transmission_coefficient_of_low_pass_filter as coefficient_law
