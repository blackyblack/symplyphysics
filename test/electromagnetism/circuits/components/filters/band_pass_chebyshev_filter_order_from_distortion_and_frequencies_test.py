...
from symplyphysics.electromagnetism.circuits.components.filters import band_pass_chebyshev_filter_order_from_distortion_and_frequencies as order_law
...
def test_basic_band_pass_chebyshev_filter_order(test_args: Args) -> None:
    result = order_law.calculate_band_pass_chebyshev_filter_order(test_args.bandwidth_distortion,
...
def test_bad_distortions(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        order_law.calculate_band_pass_chebyshev_filter_order(bad_distortion,
            test_args.band_stop_distortion, test_args.band_stop_frequency,
            test_args.cutoff_frequency, test_args.bandwidth)
    with raises(errors.UnitsError):
        order_law.calculate_band_pass_chebyshev_filter_order(test_args.bandwidth_distortion,
            bad_distortion, test_args.band_stop_frequency, test_args.cutoff_frequency,
            test_args.bandwidth)
...
def test_bad_frequencies(test_args: Args) -> None:
    ...
    with raises(TypeError):
        order_law.calculate_band_pass_chebyshev_filter_order(test_args.bandwidth_distortion,
            test_args.band_stop_distortion, 100, test_args.cutoff_frequency, test_args.bandwidth)
    with raises(errors.UnitsError):
        order_law.calculate_band_pass_chebyshev_filter_order(test_args.bandwidth_distortion,
    ...
    with raises(TypeError):
        order_law.calculate_band_pass_chebyshev_filter_order(test_args.bandwidth_distortion,
            test_args.band_stop_distortion, test_args.band_stop_frequency, 100, test_args.bandwidth)
