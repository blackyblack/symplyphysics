...
from symplyphysics.electromagnetism.circuits.transient_analysis.serial_inductor_capacitor_circuit import oscillation_period_of_inductor_capacitor_network as lc
