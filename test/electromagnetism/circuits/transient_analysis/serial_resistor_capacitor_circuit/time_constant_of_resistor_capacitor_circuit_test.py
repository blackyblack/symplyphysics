...
from symplyphysics.electromagnetism.circuits.transient_analysis.serial_resistor_capacitor_circuit import time_constant_of_resistor_capacitor_circuit as law
