...
def test_args():
    ...
    par_width = Quantity(units.length, 20 * units.centimeter)
    par_length = Quantity(units.length, 20 * units.centimeter)
    par_height = Quantity(units.length, 20 * units.centimeter)
