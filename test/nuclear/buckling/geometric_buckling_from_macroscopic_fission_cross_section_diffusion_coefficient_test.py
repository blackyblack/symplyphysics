...
def test_args():
    ...
    macro_fission_cross_section = Quantity(1 / units.length, 1.482 / units.centimeter)
    macro_abs_cross_section = Quantity(1 / units.length, 3.108 / units.centimeter)
    diffusion_coefficient = Quantity(units.length, 31.782 * units.meter)
