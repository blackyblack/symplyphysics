...
def test_args():
    ...
    neutron_flux = neutron_flux_times_radius_unit * sin(pi / sphere_radius * spherical_coordinates.r * unit_length) / (spherical_coordinates.r * unit_length)
...
def test_basic_geometric_buckling(test_args):
    ...
    result_geometric_buckling = convert_to(result, 1 / units.centimeter**2).subs(units.centimeter,
        1).evalf(4)
