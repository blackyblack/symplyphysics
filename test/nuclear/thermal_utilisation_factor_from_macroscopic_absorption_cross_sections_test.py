...
@fixture
def test_args():
    macro_abs_fuel_cross_section = Quantity(1 / units.length, 0.2028 / units.centimeter)
    macro_abs_total_cross_section = Quantity(1 / units.length, 0.2356 / units.centimeter)
...
def test_bad_macroscopic_cross_section(test_args):
    ...
    Saftb = Quantity(1 / units.length, test_args.Sat.scale_factor + 1)
