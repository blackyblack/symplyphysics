...
def test_args():
    ...
    diffusion_area = Quantity(units.length**2, 39.9 * units.centimeter**2)
    # light water Fermi age = 38.8 cm^2
    neutron_fermi_age = Quantity(units.length**2, 38.8 * units.centimeter**2)
