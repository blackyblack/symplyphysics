...
from symplyphysics.reorganized.classical_mechanics.kinematics.general_motion import acceleration_is_normal_plus_tangential_acceleration as acceleration_law
