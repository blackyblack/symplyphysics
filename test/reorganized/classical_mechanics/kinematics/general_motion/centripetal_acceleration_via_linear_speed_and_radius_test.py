...
from symplyphysics.reorganized.classical_mechanics.kinematics.general_motion import centripetal_acceleration_via_linear_speed_and_radius as centripetal_acceleration_def
