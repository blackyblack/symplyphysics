...
from symplyphysics.reorganized.classical_mechanics.kinematics.rotational_inertia import rotational_inertia_cartesian_integral as rotational_inertia_law
