...
from symplyphysics.reorganized.classical_mechanics.kinematics.rotational_inertia import rotational_inertia_of_solid_disk_about_central_axis as solid_disk
