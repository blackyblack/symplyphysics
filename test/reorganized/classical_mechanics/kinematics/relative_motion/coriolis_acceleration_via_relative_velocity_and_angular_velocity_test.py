...
from symplyphysics.reorganized.classical_mechanics.kinematics.relative_motion import coriolis_acceleration_via_relative_velocity_and_angular_velocity as law
