...
from symplyphysics.reorganized.classical_mechanics.kinematics.projectile_motion import maximum_height_of_a_body_thrown_at_an_angle_to_horizon as height_law
