...
from symplyphysics.reorganized.classical_mechanics.kinematics.projectile_motion import range_of_flight_of_a_body_thrown_at_an_angle_to_horizon as range_law
