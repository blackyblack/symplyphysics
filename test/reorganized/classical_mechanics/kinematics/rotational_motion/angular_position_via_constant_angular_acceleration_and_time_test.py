...
from symplyphysics.reorganized.classical_mechanics.kinematics.rotational_motion import angular_position_via_constant_angular_acceleration_and_time as angular_displacement_law
...
Args = namedtuple("Args", "th0 w0 alpha t")
...
def test_args_fixture() -> Args:
    ...
    return Args(th0=th0, w0=w0, alpha=alpha, t=t)
