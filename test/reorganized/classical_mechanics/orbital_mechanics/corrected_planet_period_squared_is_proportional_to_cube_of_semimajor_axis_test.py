...
from symplyphysics.reorganized.classical_mechanics.orbital_mechanics import corrected_planet_period_squared_is_proportional_to_cube_of_semimajor_axis as law
