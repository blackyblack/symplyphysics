...
from symplyphysics.reorganized.classical_mechanics.orbital_mechanics import area_rate_of_change_is_proportional_to_angular_momentum as keplers_second_law
