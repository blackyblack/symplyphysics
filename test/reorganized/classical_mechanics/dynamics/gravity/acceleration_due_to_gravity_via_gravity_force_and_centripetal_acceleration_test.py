...
from symplyphysics.reorganized.classical_mechanics.dynamics.gravity import acceleration_due_to_gravity_via_gravity_force_and_centripetal_acceleration as law
