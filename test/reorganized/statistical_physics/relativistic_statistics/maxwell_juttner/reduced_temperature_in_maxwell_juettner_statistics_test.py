...
from symplyphysics.reorganized.statistical_physics.relativistic_statistics.maxwell_juttner import reduced_temperature_in_maxwell_juettner_statistics as law
