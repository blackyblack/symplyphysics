...
from symplyphysics.reorganized.statistical_physics.classical_statistics.maxwell_boltzmann import maxwell_boltzmann_velocity_component_distribution as distribution_law
