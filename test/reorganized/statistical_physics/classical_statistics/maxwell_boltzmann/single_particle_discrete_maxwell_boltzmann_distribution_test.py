...
from symplyphysics.reorganized.statistical_physics.classical_statistics.maxwell_boltzmann import single_particle_discrete_maxwell_boltzmann_distribution as law
