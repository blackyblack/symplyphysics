...
from symplyphysics.reorganized.statistical_physics.classical_statistics.maxwell_boltzmann import maxwell_boltzmann_speed_distribution as distribution_law
...
def test_law(test_args: Args) -> None:
    result = distribution_law.calculate_speed_distribution_function(test_args.v, test_args.m,
        test_args.t)
