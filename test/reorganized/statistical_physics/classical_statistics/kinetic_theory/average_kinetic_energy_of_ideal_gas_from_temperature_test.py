...
from symplyphysics.reorganized.statistical_physics.classical_statistics.kinetic_theory import average_kinetic_energy_of_ideal_gas_from_temperature as average_kinetic_energy
