...
from symplyphysics.reorganized.statistical_physics.classical_statistics.kinetic_theory import number_of_impacts_of_molecules_on_the_wall_from_area_and_velocity as number_of_impacts
...
def test_basic_number_of_impacts(test_args: Args) -> None:
...
def test_bad_molecules_concentration(test_args: Args) -> None:
...
def test_bad_velocity_projection(test_args: Args) -> None:
