...
from symplyphysics.reorganized.statistical_physics.classical_statistics.kinetic_theory import internal_energy_of_ideal_gas_via_temperature as inner_energy_law
