...
from symplyphysics.reorganized.statistical_physics.classical_statistics.kinetic_theory import mean_free_path_of_particles_in_gaseous_medium as path_law
