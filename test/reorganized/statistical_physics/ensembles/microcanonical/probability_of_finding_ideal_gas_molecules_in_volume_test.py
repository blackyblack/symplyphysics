...
from symplyphysics.reorganized.statistical_physics.ensembles.microcanonical import probability_of_finding_ideal_gas_molecules_in_volume as probability_law
