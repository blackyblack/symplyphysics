...
from symplyphysics.reorganized.statistical_physics.ensembles.canonical import boltzmann_factor_via_state_energy_and_temperature
...
def test_bad_energy(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        boltzmann_factor_via_state_energy_and_temperature.calculate_boltzmann_factor(
            eb, test_args.t)
