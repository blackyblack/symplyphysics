...
from symplyphysics.reorganized.statistical_physics.ensembles.canonical import canonical_partition_function_of_classical_discrete_system as partition_function_law
