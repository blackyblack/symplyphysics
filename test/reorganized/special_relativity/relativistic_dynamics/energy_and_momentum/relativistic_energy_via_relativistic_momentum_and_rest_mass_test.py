...
from symplyphysics.reorganized.special_relativity.relativistic_dynamics.energy_and_momentum import relativistic_energy_via_relativistic_momentum_and_rest_mass as relation
