...
from symplyphysics.reorganized.special_relativity.relativistic_kinematics.velocity_addition import relativistic_velocity_orthogonal_to_movement as law
