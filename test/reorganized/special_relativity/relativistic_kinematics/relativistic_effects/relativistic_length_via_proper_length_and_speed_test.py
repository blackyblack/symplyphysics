...
from symplyphysics.reorganized.special_relativity.relativistic_kinematics.relativistic_effects import relativistic_length_via_proper_length_and_speed as law
