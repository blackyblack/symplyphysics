...
from symplyphysics.reorganized.special_relativity.relativistic_kinematics.relativistic_effects import spacetime_interval_is_lorentz_invariant as invariant_law
