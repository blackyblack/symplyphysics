...
from symplyphysics.reorganized.special_relativity.rocket_mechanics import rocket_thrust_is_rocket_mass_times_acceleration as rocket_law
...
def test_bad_consumption_rate(test_args: Args) -> None:
