...
from symplyphysics.reorganized.special_relativity.rocket_mechanics import relative_rocket_speed_from_mass_change_and_effective_exhaust_speed as speed_law
