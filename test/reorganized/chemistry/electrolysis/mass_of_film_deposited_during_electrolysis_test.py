...
from symplyphysics.reorganized.chemistry.electrolysis import mass_of_film_deposited_during_electrolysis as mass_law
...
def test_basic_mass_of_film(test_args: Args) -> None:
    result = mass_law.calculate_mass_of_film(test_args.current, test_args.molar_mass,
        test_args.current_output, test_args.valence, test_args.time)
...
def test_bad_current(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        mass_law.calculate_mass_of_film(current, test_args.molar_mass, test_args.current_output,
            test_args.valence, test_args.time)
    with raises(TypeError):
        mass_law.calculate_mass_of_film(100, test_args.molar_mass, test_args.current_output,
            test_args.valence, test_args.time)
...
def test_bad_molar_mass(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        mass_law.calculate_mass_of_film(test_args.current, molar_mass, test_args.current_output,
            test_args.valence, test_args.time)
    with raises(TypeError):
        mass_law.calculate_mass_of_film(test_args.current, 100, test_args.current_output,
            test_args.valence, test_args.time)
...
def test_bad_current_output(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        mass_law.calculate_mass_of_film(test_args.current, test_args.molar_mass, current_output,
            test_args.valence, test_args.time)
...
def test_bad_valence(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        mass_law.calculate_mass_of_film(test_args.current, test_args.molar_mass,
            test_args.current_output, valence, test_args.time)
...
def test_bad_time(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        mass_law.calculate_mass_of_film(test_args.current, test_args.molar_mass,
            test_args.current_output, test_args.valence, time)
    with raises(TypeError):
        mass_law.calculate_mass_of_film(test_args.current, test_args.molar_mass,
            test_args.current_output, test_args.valence, 100)
