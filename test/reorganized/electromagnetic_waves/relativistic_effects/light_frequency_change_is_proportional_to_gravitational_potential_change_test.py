...
from symplyphysics.reorganized.electromagnetic_waves.relativistic_effects import light_frequency_change_is_proportional_to_gravitational_potential_change as law
