...
from symplyphysics.reorganized.electromagnetic_waves.doppler_effect import longitudinal_frequency_shift_from_absolute_velocities as doppler_law
...
def test_classical_moving_observer_frequency(test_args: Args) -> None:
...
def test_moving_observer_frequency(test_args: Args) -> None:
