...
from symplyphysics.reorganized.thermodynamics.thermodynamic_potentials.definitions import helmholtz_free_energy_via_internal_energy as free_energy_law
