...
from symplyphysics.reorganized.thermodynamics.thermodynamic_potentials.maxwell_relations import entropy_derivative_via_volume_derivative as maxwell_relation
