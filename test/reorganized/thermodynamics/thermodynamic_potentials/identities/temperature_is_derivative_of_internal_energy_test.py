...
from symplyphysics.reorganized.thermodynamics.thermodynamic_potentials.identities import temperature_is_derivative_of_internal_energy as temperature_law
