...
from symplyphysics.reorganized.thermodynamics.thermodynamic_potentials.identities import temperature_derivative_via_volume_derivative as joule_thompson_law
