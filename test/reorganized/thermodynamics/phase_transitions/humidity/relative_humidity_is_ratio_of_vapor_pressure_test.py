...
from symplyphysics.reorganized.thermodynamics.phase_transitions.humidity import relative_humidity_is_ratio_of_vapor_pressure as humidity_law
...
def test_basic_relative_humidity(test_args: Args) -> None:
    result = humidity_law.calculate_relative_humidity(test_args.water_vapor_pressure,
        test_args.saturated_vapor_pressure)
