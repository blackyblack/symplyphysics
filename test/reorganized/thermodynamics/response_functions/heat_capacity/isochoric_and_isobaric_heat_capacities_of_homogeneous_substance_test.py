...
from symplyphysics.reorganized.thermodynamics.response_functions.heat_capacity import isochoric_and_isobaric_heat_capacities_of_homogeneous_substance as mayers_relation
