...
from symplyphysics.reorganized.thermodynamics.response_functions.thermal_expansion import fractional_volume_change_via_small_temperature_change as law
