...
from symplyphysics.reorganized.thermodynamics.chemical_thermodynamics import isobaric_potential_of_temperature_dependent_heat_capacity as potential_law
...
def test_basic_isobaric_potential(test_args: Args) -> None:
    result = potential_law.calculate_isobaric_potential(
