...
from symplyphysics.reorganized.thermodynamics.continuum_thermodynamics.dielectric_thermodynamics import enthalpy_change_via_entropy_change_and_electric_field_change as law
