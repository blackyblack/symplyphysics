...
from symplyphysics.reorganized.oscillations.mechanical_oscillations.damped_oscillations import damped_angular_frequency_via_damping_ratio as damped_law
