...
from symplyphysics.reorganized.oscillations.mechanical_oscillations.spring import period_of_spring_from_mass as spring_period
...
def test_bad_elascticity(test_args: Args) -> None:
