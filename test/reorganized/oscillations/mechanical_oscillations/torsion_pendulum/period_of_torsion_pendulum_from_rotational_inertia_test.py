...
from symplyphysics.reorganized.oscillations.mechanical_oscillations.torsion_pendulum import period_of_torsion_pendulum_from_rotational_inertia as pendulum_law
