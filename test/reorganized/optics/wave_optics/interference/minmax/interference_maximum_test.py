...
from symplyphysics.reorganized.optics.wave_optics.interference.minmax import interference_maximum as maximum_law
...
def test_bad_number_maximum(test_args: Args) -> None:
