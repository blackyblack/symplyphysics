...
from symplyphysics.reorganized.optics.geometrical_optics.lenses import linear_magnification_from_distance_to_object_and_distance_to_image as magnification
