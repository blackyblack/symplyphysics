...
from symplyphysics.reorganized.electromagnetism.electrostatics.point_charge import electrostatic_potential_is_work_to_bring_from_reference_point_over_charge as work_law
