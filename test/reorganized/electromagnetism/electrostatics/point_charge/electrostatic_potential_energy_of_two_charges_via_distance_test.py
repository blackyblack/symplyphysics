...
from symplyphysics.reorganized.electromagnetism.electrostatics.point_charge import electrostatic_potential_energy_of_two_charges_via_distance as energy_law
