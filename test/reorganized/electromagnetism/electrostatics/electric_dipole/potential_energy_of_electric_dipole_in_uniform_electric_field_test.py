...
from symplyphysics.reorganized.electromagnetism.electrostatics.electric_dipole import potential_energy_of_electric_dipole_in_uniform_electric_field as law
