...
from symplyphysics.reorganized.electromagnetism.electrostatics.electric_dipole import electric_dipole_moment_is_charge_times_displacement as dipole_moment
