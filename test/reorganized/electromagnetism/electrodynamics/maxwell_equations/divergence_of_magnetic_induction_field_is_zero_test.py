...
from symplyphysics.reorganized.electromagnetism.electrodynamics.maxwell_equations import (
    divergence_of_magnetic_induction_field_is_zero as divergence_cond,)

from symplyphysics.core.coordinate_systems import (CARTESIAN, CoordinateVector, CoordinateScalar)
