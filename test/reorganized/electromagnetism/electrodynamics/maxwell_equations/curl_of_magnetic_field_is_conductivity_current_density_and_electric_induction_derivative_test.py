...
from symplyphysics.reorganized.electromagnetism.electrodynamics.maxwell_equations import curl_of_magnetic_field_is_conductivity_current_density_and_electric_induction_derivative as current_density_law
