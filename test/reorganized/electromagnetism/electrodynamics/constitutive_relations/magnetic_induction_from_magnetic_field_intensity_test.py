...
from symplyphysics.reorganized.electromagnetism.electrodynamics.constitutive_relations import magnetic_induction_from_magnetic_field_intensity as induction_law
