...
from symplyphysics.reorganized.electromagnetism.electrodynamics.electromotive_force import self_induced_electromotive_force_via_time_derivative_of_current as self_induction_def
