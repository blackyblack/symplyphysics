...
from symplyphysics.reorganized.condensed_matter.ionization import volumetric_ionization_coefficient_of_neutral_particles_by_electrons as coefficient_law
