...
from symplyphysics.reorganized.quantum_physics.light_interaction import light_pressure_via_radiation_intensity_and_reflection_coefficient as pressure_law
