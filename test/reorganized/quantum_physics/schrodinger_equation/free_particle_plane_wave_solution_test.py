...
from symplyphysics.reorganized.quantum_physics.schrodinger_equation import free_particle_plane_wave_solution as solution_law
...
def test_law(test_args: Args) -> None:
    result = solution_law.calculate_wave_function_value(test_args.p, test_args.e, test_args.x,
        test_args.t)
    assert_equal(result.real, 0.70, relative_tolerance=5e-3)
    assert_equal(result.imag, -0.72, relative_tolerance=5e-3)
