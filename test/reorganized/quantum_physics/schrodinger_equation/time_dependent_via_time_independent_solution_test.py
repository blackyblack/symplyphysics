...
from symplyphysics.reorganized.quantum_physics.schrodinger_equation import time_dependent_via_time_independent_solution as law
...
def test_law(test_args: Args) -> None:
    result = law.calculate_time_dependent_wave_function_value(test_args.psi, test_args.e,
        test_args.t)
