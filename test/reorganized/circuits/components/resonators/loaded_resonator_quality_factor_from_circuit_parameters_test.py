...
from symplyphysics.reorganized.circuits.components.resonators import loaded_resonator_quality_factor_from_circuit_parameters as factor_law
...
def test_args_fixture() -> Args:
    ...
    frequency = Quantity(4 * pi * prefixes.kilo * units.hertz)
