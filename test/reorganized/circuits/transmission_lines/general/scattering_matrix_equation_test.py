...
from symplyphysics.reorganized.circuits.transmission_lines.general import scattering_matrix_equation as parameters_matrix_law
...
def test_basic_waves(test_args: Args) -> None:
    ...
    assert_equal(result[0], 0.286 * sqrt(units.watt), relative_tolerance=0.002)
    assert_equal(result[1], 0.286 * sqrt(units.watt), relative_tolerance=0.002)
