...
from symplyphysics.reorganized.circuits.transmission_lines.general import wave_resistance_of_microstrip_line_for_effective_width_greater_thickness as resistance_law

## The effective permittivity of the microstrip line is 2.5. The effective width of the microstrip line is 5 millimeter, and the thickness of the substrate
## is 4 millimeters. Then the wave resistance of the microstrip line will be equal to 72.16 ohm.
...
def test_basic_resistance(test_args: Args) -> None:
    ...
    assert_equal(result, 72.16 * units.ohm)
