...
from symplyphysics.reorganized.circuits.transmission_lines.general import ratio_of_average_power_to_incident_power_from_standing_wave_coefficient as coefficient_law
