...
from symplyphysics.reorganized.circuits.transmission_lines.microstrip_lines import attenuation_coefficient_in_metal_of_microstrip_line_for_width_greater_thickness as coefficient_law
