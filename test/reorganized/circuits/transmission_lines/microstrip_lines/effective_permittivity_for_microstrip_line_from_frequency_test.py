...
from symplyphysics.reorganized.circuits.transmission_lines.microstrip_lines import effective_permittivity_for_microstrip_line_from_frequency as permittivity_law
