...
from symplyphysics.reorganized.continuum_mechanics.elasticity.energy import elastic_energy_density_of_bulk_compression_via_pressure as law
...
def test_law(test_args: Args) -> None:
    ...
    assert_equal(result,
        6.2 * prefixes.kilo * units.joule / units.meter**3,
