...
from symplyphysics.reorganized.continuum_mechanics.elasticity.strain import engineering_normal_strain_is_total_deformation_over_initial_dimension as law
