...
from symplyphysics.reorganized.continuum_mechanics.fluid_mechanics.similarity_parameters import prandtl_number_via_dynamic_viscosity_and_thermal_conductivity as law
