...
from symplyphysics.reorganized.nuclear_physics.general import thermal_utilisation_factor_from_macroscopic_absorption_cross_sections as utilisation_factor
