...
from symplyphysics.reorganized.nuclear_physics.general import resonance_escape_probability_from_resonance_absorption_integral as resonance_escape
...
def test_basic_resonance_escape_factor(test_args: Args) -> None:
