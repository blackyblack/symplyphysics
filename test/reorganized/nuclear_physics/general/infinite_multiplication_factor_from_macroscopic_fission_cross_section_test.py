...
from symplyphysics.reorganized.nuclear_physics.general import infinite_multiplication_factor_from_macroscopic_fission_cross_section as multiplication_factor
