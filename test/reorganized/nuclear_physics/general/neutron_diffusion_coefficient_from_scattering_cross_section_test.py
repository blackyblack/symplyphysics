...
from symplyphysics.reorganized.nuclear_physics.general import neutron_diffusion_coefficient_from_scattering_cross_section as diffusion_coeff
...
def test_bad_macroscopic_cross_section() -> None:
