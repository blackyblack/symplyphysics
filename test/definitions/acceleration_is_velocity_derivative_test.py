...
@fixture
def test_args():
    v0 = Quantity("v0", units.velocity, 1 * units.meter / units.second)
    v1 = Quantity("v1", units.velocity, 20 * units.meter / units.second)
    t = Quantity("t", units.time, 5 * units.second)
