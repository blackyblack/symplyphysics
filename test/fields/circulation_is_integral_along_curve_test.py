...
def test_basic_circulation(test_args: Args) -> None:
...
def test_force_circulation(test_args: Args) -> None:
...
def test_force_circulation_horizontal(test_args: Args) -> None:
...
def test_force_circulation_horizontal_up(test_args: Args) -> None:
...
def test_force_circulation_horizontal_down(test_args: Args) -> None:
