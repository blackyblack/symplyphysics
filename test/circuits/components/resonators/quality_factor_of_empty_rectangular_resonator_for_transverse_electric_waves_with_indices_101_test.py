...
from symplyphysics.circuits.components.resonators import quality_factor_of_empty_rectangular_resonator_for_transverse_electric_waves_with_indices_101 as factor_law
