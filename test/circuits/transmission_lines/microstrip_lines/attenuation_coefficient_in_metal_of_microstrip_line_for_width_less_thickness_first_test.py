...
from symplyphysics.circuits.transmission_lines.microstrip_lines import attenuation_coefficient_in_metal_of_microstrip_line_for_width_less_thickness_first as coefficient_law
