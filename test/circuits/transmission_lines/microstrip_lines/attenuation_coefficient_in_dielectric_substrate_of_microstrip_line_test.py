...
from symplyphysics.circuits.transmission_lines.microstrip_lines import attenuation_coefficient_in_dielectric_substrate_of_microstrip_line as coefficient_law
