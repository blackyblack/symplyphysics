...
def test_basic_force():
    ...
    result_force = solve(newton_third_law.law,
                         newton_third_law.force_reaction,
    ...
    assert result.coeff(
        cartesian_coordinates.x) == -1 * Faction.coeff(cartesian_coordinates.x)
    assert result.coeff(
        cartesian_coordinates.y) == -1 * Faction.coeff(cartesian_coordinates.y)
    assert result.coeff(
        cartesian_coordinates.z) == -1 * Faction.coeff(cartesian_coordinates.z)
