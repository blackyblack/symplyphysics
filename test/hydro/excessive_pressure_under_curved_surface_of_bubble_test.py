...
def test_args_fixture() -> Args:
    ...
    return Args(surface_tension_of_the_liquid=surface_tension_of_the_liquid, radius_of_bubble=radius_of_bubble)


def test_basic_excessive_pressure(test_args: Args) -> None:
    result = pressure_law.calculate_excessive_pressure(test_args.surface_tension_of_the_liquid, test_args.radius_of_bubble)
...
def test_bad_surface_tension_of_the_liquid(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        pressure_law.calculate_excessive_pressure(surface_tension_of_the_liquid, test_args.radius_of_bubble)
...
def test_bad_radius_of_bubble(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        pressure_law.calculate_excessive_pressure(test_args.surface_tension_of_the_liquid, radius_of_bubble)
    with raises(TypeError):
