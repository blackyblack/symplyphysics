...
from symplyphysics.classical_mechanics.kinematics.rotational_motion.rotational_inertia import rotational_inertia_is_additive as rotational_inertia_law
