...
from symplyphysics.classical_mechanics.kinematics.rotational_motion import displacement_is_angular_displacement_cross_radius as linear_displacement_law
