...
from symplyphysics.classical_mechanics.kinematics.rotational_motion import angular_position_via_constant_angular_speed_and_time as angular_position_law
