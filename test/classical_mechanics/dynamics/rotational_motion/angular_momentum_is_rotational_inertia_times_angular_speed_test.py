...
from symplyphysics.classical_mechanics.dynamics.rotational_motion import angular_momentum_is_rotational_inertia_times_angular_speed as angular_momentum_law
