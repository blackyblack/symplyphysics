...
def test_args():
    ...
    return Args(dielectric_permeability = dielectric_permeability, magnetic_permeability = magnetic_permeability)

def test_basic_factor(test_args):
    result = media_law.calculate_refraction_factor(test_args.dielectric_permeability, test_args.magnetic_permeability).evalf(6)
