...
from symplyphysics.thermodynamics.response_functions.heat_capacity import isochoric_molar_heat_capacity_of_ideal_gas_via_degrees_of_freedom as heat_capacity_law
