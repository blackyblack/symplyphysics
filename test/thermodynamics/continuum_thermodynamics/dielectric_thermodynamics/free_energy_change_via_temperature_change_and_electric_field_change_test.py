...
from symplyphysics.thermodynamics.continuum_thermodynamics.dielectric_thermodynamics import free_energy_change_via_temperature_change_and_electric_field_change as law
