...
def test_basic_law(test_args):
    result = work_of_ideal_gas.calculate_work(test_args.mass, test_args.molar_mass,
...
def test_bad_mass(test_args):
    ...
    with raises(errors.UnitsError):
        work_of_ideal_gas.calculate_work(bad_mass, test_args.molar_mass, test_args.start_volume,
            test_args.final_volume, test_args.temperature)
    with raises(TypeError):
        work_of_ideal_gas.calculate_work(100, test_args.molar_mass, test_args.start_volume,
            test_args.final_volume, test_args.temperature)
...
def test_bad_volume(test_args):
    ...
    with raises(errors.UnitsError):
        work_of_ideal_gas.calculate_work(test_args.mass, test_args.molar_mass, bad_volume,
            test_args.final_volume, test_args.temperature)
    with raises(TypeError):
        work_of_ideal_gas.calculate_work(test_args.mass, test_args.molar_mass, 100,
            test_args.final_volume, test_args.temperature)
    with raises(errors.UnitsError):
        work_of_ideal_gas.calculate_work(test_args.mass, test_args.molar_mass,
