...
from symplyphysics.thermodynamics.thermodynamic_potentials.identities import chemical_potential_is_gibbs_energy_per_particle as chemical_potential_law
