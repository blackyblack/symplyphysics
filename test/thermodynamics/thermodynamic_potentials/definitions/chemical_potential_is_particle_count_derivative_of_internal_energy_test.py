...
from symplyphysics.thermodynamics.thermodynamic_potentials.definitions import chemical_potential_is_particle_count_derivative_of_internal_energy as chemical_potential_law
