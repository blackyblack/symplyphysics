...
from symplyphysics.thermodynamics.thermodynamic_potentials.legendre_transforms import internal_energy_via_helmholtz_free_energy as gibbs_helmholtz_law
