...
def test_basic_velocity(test_args):
    result = accelerated_velocity_law.calculate_velocity(
        test_args.V1, test_args.A1, test_args.T1)
    ...
    result_velocity = convert_to(result, units.meter / units.second).subs(
        units.meter / units.second, 1).evalf(2)
...
def test_bad_velocity(test_args):
    ...
    with raises(errors.UnitsError):
        accelerated_velocity_law.calculate_velocity(Vb, test_args.A1,
                                                    test_args.T1)
    with raises(TypeError):
        accelerated_velocity_law.calculate_velocity(100, test_args.A1,
                                                    test_args.T1)
...
def test_bad_acceleration(test_args):
    ...
    with raises(errors.UnitsError):
        accelerated_velocity_law.calculate_velocity(test_args.V1, Ab,
                                                    test_args.T1)
    with raises(TypeError):
        accelerated_velocity_law.calculate_velocity(test_args.V1, 100,
                                                    test_args.T1)
...
def test_bad_time(test_args):
    ...
    with raises(errors.UnitsError):
        accelerated_velocity_law.calculate_velocity(test_args.V1, test_args.A1,
                                                    Tb)
    with raises(TypeError):
        accelerated_velocity_law.calculate_velocity(test_args.V1, test_args.A1,
                                                    100)
