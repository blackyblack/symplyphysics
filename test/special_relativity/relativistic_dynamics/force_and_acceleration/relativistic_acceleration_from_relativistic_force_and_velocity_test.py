...
from symplyphysics.special_relativity.relativistic_dynamics.force_and_acceleration import relativistic_acceleration_from_relativistic_force_and_velocity as law
