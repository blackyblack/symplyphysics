...
def test_args():
    ...
    Args = namedtuple('Args', ['earth_mass', 'earth_radius'])
    return Args(earth_mass=earth_mass, earth_radius=earth_radius)

def test_basic_acceleration(test_args):
    result = free_fall_acceleration.calculate_acceleration(test_args.earth_mass, test_args.earth_radius)
