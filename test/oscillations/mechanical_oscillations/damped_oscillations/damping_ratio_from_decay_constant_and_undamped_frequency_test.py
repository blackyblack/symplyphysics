...
from symplyphysics.oscillations.mechanical_oscillations.damped_oscillations import damping_ratio_from_decay_constant_and_undamped_frequency as decay_law
