...
from symplyphysics.laws.electricity import electromotive_force_of_induction_in_rotating_ce_of_induction_in_rotating_circuit as electromotive_force_law
