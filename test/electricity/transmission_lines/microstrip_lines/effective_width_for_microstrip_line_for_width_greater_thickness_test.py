...
from symplyphysics.laws.electricity.transmission_lines.microstrip_lines import effective_width_for_microstrip_line_for_width_greater_thickness as effective_width_law
...
def test_bad_width(test_args: Args) -> None:
    ...
    with raises(ValueError):
        effective_width_law.calculate_effective_width(test_args.strip_thickness, thickness_of_substrate,
            test_args.width)
