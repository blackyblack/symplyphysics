...
Args = namedtuple("Args", [
    "relative_permittivity", "frequency", "thickness_of_substrate", "width", "effective_permittivity_without_frequency"
])
...
def test_bad_permittivities(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        permittivity_law.calculate_effective_permittivity(bad_permittivity,
            test_args.frequency, test_args.thickness_of_substrate,
            test_args.width, test_args.effective_permittivity_without_frequency)
    with raises(errors.UnitsError):
        permittivity_law.calculate_effective_permittivity(test_args.relative_permittivity,
            test_args.frequency, test_args.thickness_of_substrate,
            test_args.width, bad_permittivity)
...
def test_bad_frequency(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        permittivity_law.calculate_effective_permittivity(test_args.relative_permittivity,
            bad_frequency, test_args.thickness_of_substrate, test_args.width, test_args.effective_permittivity_without_frequency)
    with raises(TypeError):
        permittivity_law.calculate_effective_permittivity(test_args.relative_permittivity,
            100, test_args.thickness_of_substrate, test_args.width, test_args.effective_permittivity_without_frequency)
...
def test_bad_thickness_of_substrate(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        permittivity_law.calculate_effective_permittivity(test_args.relative_permittivity,
            test_args.frequency, bad_thickness_of_substrate, test_args.width, test_args.effective_permittivity_without_frequency)
    with raises(TypeError):
        permittivity_law.calculate_effective_permittivity(test_args.relative_permittivity,
            test_args.frequency, 100, test_args.width, test_args.effective_permittivity_without_frequency)
...
def test_bad_width(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        permittivity_law.calculate_effective_permittivity(test_args.relative_permittivity,
            test_args.frequency, test_args.thickness_of_substrate, bad_width, test_args.effective_permittivity_without_frequency)
    with raises(TypeError):
        permittivity_law.calculate_effective_permittivity(test_args.relative_permittivity,
            test_args.frequency, test_args.thickness_of_substrate, 100, test_args.effective_permittivity_without_frequency)
