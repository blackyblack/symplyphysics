...
from symplyphysics.laws.electricity.transmission_lines.microstrip_lines import attenuation_coefficient_in_metall_of_microstrip_line_for_width_greater_thickness as coefficient_law
...
Args = namedtuple("Args", [
    "surface_resistance", "wave_resistance", "thickness_of_substrate", "effective_width", "strip_thickness", "effective_permittivity"
])
...
def test_basic_attenuation_coefficient(test_args: Args) -> None:
    result = coefficient_law.calculate_attenuation_coefficient(
        ...
        test_args.effective_width, test_args.strip_thickness, test_args.effective_permittivity)
...
def test_bad_resistances(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            bad_resistance, test_args.thickness_of_substrate, test_args.effective_width, test_args.strip_thickness, test_args.effective_permittivity)
    with raises(TypeError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            100, test_args.thickness_of_substrate, test_args.effective_width, test_args.strip_thickness, test_args.effective_permittivity)
...
def test_bad_thickness_of_substrate(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, thickness_of_substrate, test_args.effective_width, test_args.strip_thickness, test_args.effective_permittivity)
    with raises(TypeError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, 100, test_args.effective_width, test_args.strip_thickness, test_args.effective_permittivity)
    with raises(ValueError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, test_args.effective_width, test_args.thickness_of_substrate, test_args.strip_thickness, test_args.effective_permittivity)
...
def test_bad_effective_width(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, test_args.thickness_of_substrate, effective_width, test_args.strip_thickness, test_args.effective_permittivity)
    with raises(TypeError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, test_args.thickness_of_substrate, 100, test_args.strip_thickness, test_args.effective_permittivity)
...
def test_bad_strip_thickness(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, test_args.thickness_of_substrate, test_args.effective_width, strip_thickness, test_args.effective_permittivity)
    with raises(TypeError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, test_args.thickness_of_substrate, test_args.effective_width, 100, test_args.effective_permittivity)
...
def test_bad_effective_permittivity(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        coefficient_law.calculate_attenuation_coefficient(test_args.surface_resistance,
            test_args.wave_resistance, test_args.thickness_of_substrate, test_args.effective_width, test_args.strip_thickness, effective_permittivity)
