...
from symplyphysics.laws.electricity.circuits.waveguides import phase_velocity_of_wave_in_rectangular_waveguide as velocity_law
...
def test_basic_phase_velocity(test_args: Args) -> None:
    result = velocity_law.calculate_phase_velocity(test_args.relative_permittivity,
...
def test_bad_relative_permittivity(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        velocity_law.calculate_phase_velocity(relative_permittivity,
            test_args.relative_permeability, test_args.wavelength, test_args.critical_wavelength)
...
def test_bad_relative_permeability(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        velocity_law.calculate_phase_velocity(test_args.relative_permittivity,
