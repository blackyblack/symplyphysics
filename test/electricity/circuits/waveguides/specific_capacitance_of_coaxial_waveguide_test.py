...
def test_basic_specific_capacitance(test_args: Args) -> None:
    result = capacitance_law.calculate_specific_capacitance(test_args.relative_permittivity,
...
def test_bad_relative_permittivity(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        capacitance_law.calculate_specific_capacitance(bad_relative_permittivity,
            test_args.outer_radius, test_args.inner_radius)
...
def test_bad_radius(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        capacitance_law.calculate_specific_capacitance(test_args.relative_permittivity, bad_radius,
            test_args.inner_radius)
    with raises(TypeError):
        capacitance_law.calculate_specific_capacitance(test_args.relative_permittivity, 100,
            test_args.inner_radius)
    with raises(errors.UnitsError):
        capacitance_law.calculate_specific_capacitance(test_args.relative_permittivity,
