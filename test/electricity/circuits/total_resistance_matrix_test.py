...
Args = namedtuple("Args", ["input_voltage", "output_voltage", "impedance_11", "impedance_12", "impedance_21", "impedance_22"])
...
def test_args_fixture() -> Args:
    ...
    impedance_11 = Quantity(100 * units.ohm)
    impedance_12 = Quantity(50 * units.ohm)
    impedance_21 = Quantity(50 * units.ohm)
    impedance_22 = Quantity(1000 * units.ohm)
    return Args(input_voltage=input_voltage,
        output_voltage=output_voltage,
        impedance_11=impedance_11,
        impedance_12=impedance_12,
        impedance_21=impedance_21,
        impedance_22=impedance_22)
