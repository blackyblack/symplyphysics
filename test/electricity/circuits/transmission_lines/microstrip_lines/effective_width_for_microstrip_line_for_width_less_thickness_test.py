...
from symplyphysics.laws.electricity.circuits.transmission_lines.microstrip_lines import effective_width_for_microstrip_line_for_width_less_thickness as effective_width_law
...
def test_basic_effective_width(test_args: Args) -> None:
    ...
    assert_equal(result, 1.13 * units.millimeter)
