...
from symplyphysics.laws.electricity.circuits.transmission_lines.microstrip_lines import short_circuit_inductance_of_microstrip_line as inductance_law
...
def test_basic_inductance(test_args: Args) -> None:
    result = inductance_law.calculate_inductance(test_args.thickness_of_substrate,
        test_args.radius_of_hole)
