...
## The standard transmission line resistance is 50 ohms, the power ratio at the output ports equal to 2. 
...
def test_basic_impedances(test_args: Args) -> None:
    result = impedances_law.calculate_impedances(test_args.characteristic_resistance, test_args.ratio_of_power)
...
def test_bad_characteristic_resistance(test_args: Args) -> None:
    ...
    with raises(TypeError):
        impedances_law.calculate_impedances(100, test_args.ratio_of_power, test_args)
