...
Args = namedtuple("Args", ["bandwidth_distortion", "band_stop_distortion", "cutoff_frequency", "upper_stop_frequency", "bandwidth"])
...
def test_args_fixture() -> Args:
    ...
    upper_stop_frequency = Quantity(18 * units.hertz)
    ...
    return Args(bandwidth_distortion=bandwidth_distortion,
        ...
        upper_stop_frequency=upper_stop_frequency,
...
def test_basic_chebyshev_filter_order(test_args: Args) -> None:
    result = order_law.calculate_chebyshev_filter_order(test_args.bandwidth_distortion, test_args.band_stop_distortion,
        test_args.upper_stop_frequency, test_args.cutoff_frequency, test_args.bandwidth)
...
def test_bad_distortions(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        order_law.calculate_chebyshev_filter_order(bad_distortion, test_args.band_stop_distortion, test_args.upper_stop_frequency,
            test_args.cutoff_frequency, test_args.bandwidth)
    with raises(errors.UnitsError):
        order_law.calculate_chebyshev_filter_order(test_args.bandwidth_distortion, bad_distortion, test_args.upper_stop_frequency,
            test_args.cutoff_frequency, test_args.bandwidth)
...
def test_bad_frequencies(test_args: Args) -> None:
    ...
    with raises(TypeError):
        order_law.calculate_chebyshev_filter_order(test_args.bandwidth_distortion, test_args.band_stop_distortion, 100,
            test_args.cutoff_frequency, test_args.bandwidth)
    with raises(errors.UnitsError):
        order_law.calculate_chebyshev_filter_order(test_args.bandwidth_distortion, test_args.band_stop_distortion, test_args.upper_stop_frequency,
