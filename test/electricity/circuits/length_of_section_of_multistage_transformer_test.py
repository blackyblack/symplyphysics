...
Args = namedtuple("Args", ["wavelength_for_upper_frequency", "wavelength_lower_frequency"])
...
def test_args_fixture() -> Args:
    ...
    return Args(wavelength_for_upper_frequency=wavelength_for_upper_frequency, wavelength_lower_frequency=wavelength_lower_frequency)
