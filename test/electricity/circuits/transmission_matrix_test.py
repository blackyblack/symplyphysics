...
from symplyphysics.laws.electricity.circuits import transmission_matrix as parameter_matrix_law
...
def test_basic_current_and_voltage(test_args: Args) -> None:
    result = parameter_matrix_law.calculate_current_and_voltage(test_args.input_voltage, test_args.input_current, test_args.parameters)
...
def test_bad_voltage(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        parameter_matrix_law.calculate_current_and_voltage(bad_voltage, test_args.input_current, test_args.parameters)
    with raises(TypeError):
        parameter_matrix_law.calculate_current_and_voltage(100, test_args.input_current, test_args.parameters)
...
def test_bad_parameters(test_args: Args) -> None:
    ...
    with raises(errors.UnitsError):
        parameter_matrix_law.calculate_current_and_voltage(test_args.input_voltage, test_args.input_current, ((test_args.parameters[0][0], bad_parameter), (test_args.parameters[1][0], test_args.parameters[1][1])))
    with raises(TypeError):
        parameter_matrix_law.calculate_current_and_voltage(test_args.input_voltage, test_args.input_current, ((test_args.parameters[0][0], 100), (test_args.parameters[1][0], test_args.parameters[1][1])))
    with raises(errors.UnitsError):
        parameter_matrix_law.calculate_current_and_voltage(test_args.input_voltage, test_args.input_current, ((test_args.parameters[0][0], test_args.parameters[0][1]), (bad_parameter, test_args.parameters[1][1])))
    with raises(TypeError):
        parameter_matrix_law.calculate_current_and_voltage(test_args.input_voltage, test_args.input_current, ((test_args.parameters[0][0], test_args.parameters[0][1]), (100, test_args.parameters[1][1])))
