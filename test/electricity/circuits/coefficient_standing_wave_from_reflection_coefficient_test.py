...
from symplyphysics.laws.electricity.circuits import coefficient_standing_wave_from_reflection_coefficient as coefficient_law
...
def test_bad_voltages() -> None:
    bad_voltage = Quantity(1 * units.coulomb)
    with raises(errors.UnitsError):
        coefficient_law.calculate_coefficient_standing_wave(bad_voltage)
