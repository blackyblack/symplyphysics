...
def test_args_fixture() -> Args:
    ...
    return Args(maximum_voltage=maximum_voltage,
        minimum_voltage=minimum_voltage)


def test_basic_coefficient_standing_wave(test_args: Args) -> None:
    result = coefficient_law.calculate_coefficient_standing_wave(test_args.maximum_voltage, test_args.minimum_voltage)
