...
def test_basic_circulation_along_curve(test_args):
    ...
    assert_approx(result.evalf(4), (-pi / 4).evalf(4))
...
def test_circle_circulation(test_args):
    ...
    assert_approx(result.evalf(4), (2 * pi * radius**2).evalf(4))
...
def test_implicit_circulation_along_curve(test_args):
    ...
    result = circulation_along_curve(field, circle, (test_args.parameter1, 0, 2 * pi))
    assert_approx(result.evalf(4), (-18 * pi).evalf(4))
    ...
    assert_approx(result_up.evalf(4) + result_down.evalf(4), (-18 * pi).evalf(4))
...
def test_orthogonal_movement_circulation_along_curve(test_args):
    ...
    assert_approx(result.evalf(4), (2 * pi).evalf(4))
...
def test_basic_circulation_along_surface_boundary(test_args):
    ...
    assert_approx(result_from_boundary.evalf(4), result.evalf(4))
...
def test_circle_circulation_along_surface_boundary(test_args):
    ...
    result = circulation_along_surface_boundary(field, surface, (test_args.parameter1, 0, 1),
        (test_args.parameter2, 0, pi / 2))
    assert_approx(result.evalf(4), 0)
...
def test_basic_flux_across_curve(test_args):
    ...
    assert_approx(result.evalf(4), (8 * pi).evalf(4))
...
def test_ellipse_flux(test_args):
    ...
    result = flux_across_curve(field, curve, (test_args.parameter1, 0, 2 * pi))
    assert_approx(result.evalf(4), (10 * pi).evalf(4))
...
def test_basic_flux_across_surface(test_args):
    ...
    result = flux_across_surface(field, curve, (test_args.parameter1, -2, 1),
        (test_args.parameter2, 0, 2 * pi))
    assert_approx(result.evalf(4), (12 * pi).evalf(4))
...
def test_gravitational_field_flux(test_args):
    ...
    assert_approx(result.evalf(4), (4 * pi).evalf(4))
...
def test_non_parametrized_flux_across_surface_boundary(test_args):
    ...
    assert_approx(result.evalf(4), (9 * pi).evalf(4))
...
def test_basic_flux_across_sphere_boundary():
    ...
    assert_approx(result.evalf(4), (150 * pi).evalf(4))
