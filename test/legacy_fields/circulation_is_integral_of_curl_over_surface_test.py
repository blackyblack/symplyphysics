...
from symplyphysics.laws.legacy_fields import circulation_is_integral_of_curl_over_surface as circulation_def
...
def test_force_field_circulation(test_args: Args) -> None:
