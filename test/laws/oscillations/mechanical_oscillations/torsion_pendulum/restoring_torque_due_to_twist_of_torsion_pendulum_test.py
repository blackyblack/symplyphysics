...
from symplyphysics.laws.oscillations.mechanical_oscillations.torsion_pendulum import restoring_torque_due_to_twist_of_torsion_pendulum as pendulum_laws
