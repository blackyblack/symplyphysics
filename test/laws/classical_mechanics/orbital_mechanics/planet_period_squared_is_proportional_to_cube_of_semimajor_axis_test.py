...
from symplyphysics.laws.classical_mechanics.orbital_mechanics import planet_period_squared_is_proportional_to_cube_of_semimajor_axis as law_of_periods
