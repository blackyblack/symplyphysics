...
from symplyphysics.laws.classical_mechanics.kinematics.translational_motion import speed_via_constant_acceleration_and_time as accelerated_velocity_law
