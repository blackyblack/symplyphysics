...
from symplyphysics.laws.classical_mechanics.kinematics.rotational_inertia import rotational_inertia_of_thin_rod_about_axis_through_center_perpendicular_to_length as thin_rod_formula
