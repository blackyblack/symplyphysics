...
from symplyphysics.laws.classical_mechanics.dynamics.rotational_motion import torque_via_rotational_inertia_and_angular_acceleration as moment_force_law
