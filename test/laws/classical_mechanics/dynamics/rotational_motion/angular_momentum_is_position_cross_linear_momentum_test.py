...
from symplyphysics.laws.classical_mechanics.dynamics.rotational_motion import angular_momentum_is_position_cross_linear_momentum as angular_momentum_def
