...
from symplyphysics.laws.optics.wave_optics.interference.optical_distances import optical_path_length_from_geometrical_path_length_and_refractive_index as optical_path
