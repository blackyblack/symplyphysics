...
from symplyphysics.laws.circuits.transmission_lines.microstrip_lines import effective_width_for_microstrip_line_for_width_less_thickness as effective_width_law
