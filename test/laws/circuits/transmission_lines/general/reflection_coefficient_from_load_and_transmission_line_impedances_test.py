...
from symplyphysics.laws.circuits.transmission_lines.general import reflection_coefficient_from_load_and_transmission_line_impedances as coefficient_law
