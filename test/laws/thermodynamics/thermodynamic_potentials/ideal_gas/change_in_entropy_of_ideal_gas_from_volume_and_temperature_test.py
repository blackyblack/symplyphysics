...
from symplyphysics.laws.thermodynamics.thermodynamic_potentials.ideal_gas import change_in_entropy_of_ideal_gas_from_volume_and_temperature as change_in_entropy
