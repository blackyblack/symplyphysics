...
from symplyphysics.laws.thermodynamics.continuum_thermodynamics.dielectric_thermodynamics import gibbs_energy_change_via_temperature_change_and_electic_displacement_change as law
