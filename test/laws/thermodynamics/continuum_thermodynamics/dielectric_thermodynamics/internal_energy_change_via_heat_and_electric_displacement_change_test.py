...
from symplyphysics.laws.thermodynamics.continuum_thermodynamics.dielectric_thermodynamics import internal_energy_change_via_heat_and_electric_displacement_change as law
