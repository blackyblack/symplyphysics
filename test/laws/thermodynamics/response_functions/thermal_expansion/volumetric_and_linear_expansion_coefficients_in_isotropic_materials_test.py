...
from symplyphysics.laws.thermodynamics.response_functions.thermal_expansion import volumetric_and_linear_expansion_coefficients_in_isotropic_materials as coefficients_law
