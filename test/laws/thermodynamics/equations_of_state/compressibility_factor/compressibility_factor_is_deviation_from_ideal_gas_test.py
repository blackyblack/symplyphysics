...
from symplyphysics.laws.thermodynamics.equations_of_state.compressibility_factor import compressibility_factor_is_deviation_from_ideal_gas as deviation_def
