...
from symplyphysics.laws.astronomy.stellar_evolution import approximate_time_of_stars_location_on_the_main_sequence as time_law
...
def test_basic_lifetime(test_args: Args) -> None:
    ...
    assert_equal(result, 6.66e9 * units.common_year, relative_tolerance=0.01)
