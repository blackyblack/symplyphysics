...
from symplyphysics.laws.electromagnetic_waves.blackbody_radiation import radiance_of_black_body_from_temperature as stefan_boltzmann_law
...
def test_basic_radiance_heat_energy(test_args: Args) -> None:
