...
from symplyphysics.laws.special_relativity.relativistic_dynamics.energy_and_momentum import relativistic_momentum_via_rest_mass_and_speed as momentum_law
