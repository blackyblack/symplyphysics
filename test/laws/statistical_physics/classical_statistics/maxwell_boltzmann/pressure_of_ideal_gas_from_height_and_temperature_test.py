...
from symplyphysics.laws.statistical_physics.classical_statistics.maxwell_boltzmann import pressure_of_ideal_gas_from_height_and_temperature as pressure_of_ideal_gas
