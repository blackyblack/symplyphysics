...
from symplyphysics.laws.statistical_physics.classical_statistics.kinetic_theory import internal_energy_change_of_ideal_gas_via_temperature as energy_law
