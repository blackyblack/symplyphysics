...
from symplyphysics.laws.statistical_physics.classical_statistics.kinetic_theory import gas_mixture_pressure_from_partial_pressures as gas_mixture_pressure
