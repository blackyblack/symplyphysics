...
from symplyphysics.laws.classical_mechanics.kinematics.rotational_motion import average_angular_speed_is_angular_distance_over_time as angular_velocity_law
