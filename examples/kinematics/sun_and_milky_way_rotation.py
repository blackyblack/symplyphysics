...
from symplyphysics.reorganized.classical_mechanics.kinematics.general_motion import speed_via_angular_speed_and_radius as velocity_law
...
sun_angular_velocity = solve(
    velocity_law.law,
    velocity_law.angular_speed,
)[0].subs({
    velocity_law.speed: sun_speed,
    velocity_law.radius_of_curvature: distance_to_center,
})
