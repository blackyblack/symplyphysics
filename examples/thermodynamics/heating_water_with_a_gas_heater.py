...
from symplyphysics.classical_mechanics.kinematics.translational_motion import position_via_constant_speed_and_time as velocity_law
from symplyphysics.thermodynamics.equations_of_state.ideal_gas import ideal_gas_equation as clapeyron_law
