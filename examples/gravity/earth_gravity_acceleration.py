...
from symplyphysics import (
    print_expression, units, convert_to, Quantity
)
...
gravity_force = solve(gravity_law.law, gravity_law.gravitational_force, dict=True)[0][gravity_law.gravitational_force]
...
result = convert_to(result_acceleration, units.meter / (units.second **2)).subs(units.meter / (units.second **2), 1).evalf(4)
