...
from symplyphysics.laws.classical_mechanics.dynamics.energy import mechanical_energy_is_kinetic_and_potential_energy as mechanical_energy_def
from symplyphysics.laws.classical_mechanics.dynamics.translational_motion import momentum_is_mass_times_speed as momentum_def
...
from symplyphysics.laws.classical_mechanics.conservation_laws import initial_momentum_equals_final_momentum as momentum_conservation_law
from symplyphysics.laws.classical_mechanics.dynamics.force import braking_path_via_speed_and_friction_force as braking_path_law
from symplyphysics.laws.classical_mechanics.dynamics.translational_motion import kinetic_energy_from_mass_and_speed as kinetic_energy_def
from symplyphysics.laws.classical_mechanics.dynamics.gravity import potential_energy_from_mass_and_height as potential_energy_def
from symplyphysics.laws.classical_mechanics.dynamics.force import friction_force_from_normal_force as friction_law
...
kinetic_energy_after_1_elastic = kinetic_energy_def.law.rhs.subs({
    kinetic_energy_def.mass: mass_1,
    kinetic_energy_def.speed: speed_after_1,
})

kinetic_energy_after_2_elastic = kinetic_energy_def.law.rhs.subs({
    kinetic_energy_def.mass: mass_2,
    kinetic_energy_def.speed: speed_after_2,
})
...
braking_path = braking_path_law.law.rhs.subs({
    ...
    braking_path_law.speed: speed_after,
