...
oscillating_period_expr = pendulum_period.law.subs(pendulum_period.pendulum_length, pendulum_length).rhs
oscillating_period = expr_to_quantity(oscillating_period_expr)
oscillating_period_seconds = convert_to(oscillating_period, units.second).subs(units.second, 1).evalf(5)
...
print(
    f"Oscillating frequency is {oscillating_frequency_hertz} {units.hertz}\n"
)