...
from symplyphysics.classical_mechanics.kinematics.rotational_motion.rotational_inertia import rotational_inertia_of_solid_disk_about_central_axis as disk_formula
