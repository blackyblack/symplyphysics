...
from symplyphysics.oscillations.mechanical_oscillations.physical_pendulum import period_of_physical_pendulum as pendulum_law
from symplyphysics.classical_mechanics.kinematics.rotational_motion.rotational_inertia import rotational_inertia_of_thin_rod_about_axis_through_center_perpendicular_to_length as rod_inertia_law
from symplyphysics.classical_mechanics.kinematics.rotational_motion.rotational_inertia import rotational_inertia_about_axis_and_through_center_of_mass as parallel_axis_theorem
...
rod_rotational_inertia_through_com = rod_inertia_law.law.rhs.subs(rod_inertia_law.length,
    rod_length)
