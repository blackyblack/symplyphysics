...
from symplyphysics.reorganized.special_relativity.relativistic_kinematics.relativistic_effects import relativistic_time_dilation as relativistic_time_law
