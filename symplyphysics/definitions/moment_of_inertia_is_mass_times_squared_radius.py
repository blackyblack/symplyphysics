...
definition = Eq(moment_of_inertia, symbols.basic.mass * spinning_radius**2)
...
def calculate_moment_of_inertia(mass_: Quantity, radius_: Quantity) -> Quantity:
    ...
    result_expr = result_inertia_expr.subs({symbols.basic.mass: mass_, spinning_radius: radius_})
