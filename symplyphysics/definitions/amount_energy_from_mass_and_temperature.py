...
# m - body mass
# t1 - temperature_origin (origin process)
...
@validate_input(specific_heat_capacity_=units.energy / (units.mass * units.temperature), body_mass_=units.mass,
    temperature_origin_=units.temperature, temperature_end_=units.temperature,
)
@validate_output(units.energy)
def calculate_amount_energy(specific_heat_capacity_: Quantity, body_mass_: Quantity, temperature_origin_: Quantity,
    ...
    result_expr = result_amount_energy_expr.subs({specific_heat_capacity: specific_heat_capacity_,
                body_mass: body_mass_, temperature_origin: temperature_origin_, temperature_end: temperature_end_})
