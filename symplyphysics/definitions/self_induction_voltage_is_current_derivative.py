...
definition = Eq(self_induction_voltage(time),
                -1 * inductance * Derivative(current(time), time))
...
def calculate_voltage(inductance_: Quantity, current_start_: Quantity,
                      current_end_: Quantity, time_: Quantity) -> Quantity:
