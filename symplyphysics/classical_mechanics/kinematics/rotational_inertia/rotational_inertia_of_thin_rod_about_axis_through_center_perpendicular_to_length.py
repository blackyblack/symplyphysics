...
from symplyphysics.classical_mechanics.kinematics.rotational_inertia import rotational_inertia_of_slab_about_perpendicular_axis_through_center as slab_formula
