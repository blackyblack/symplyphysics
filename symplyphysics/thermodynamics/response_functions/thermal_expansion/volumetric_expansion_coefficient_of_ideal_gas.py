...
from symplyphysics.thermodynamics.response_functions.thermal_expansion import volumetric_coefficient_of_thermal_expansion as coef_def
...
_coef_expr = coef_def.law.rhs.subs(coef_def.temperature, temperature)
