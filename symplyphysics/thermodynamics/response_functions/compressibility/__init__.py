...
this quantity is also process-dependent, and most common examples are isothermal compressibility
and isentropic compressibility.

**Links:**

#. `Wikipedia — Compressibility <https://en.wikipedia.org/wiki/Compressibility>`__.
"""
