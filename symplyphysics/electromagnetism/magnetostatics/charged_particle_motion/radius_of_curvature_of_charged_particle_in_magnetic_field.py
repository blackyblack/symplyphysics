...
from symplyphysics.electromagnetism.magnetostatics.charged_particle_motion import period_of_rotation_of_charged_particle_in_magnetic_field as period_law
