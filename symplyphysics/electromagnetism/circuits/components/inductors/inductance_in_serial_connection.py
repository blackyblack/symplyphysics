...
from symplyphysics.electromagnetism.magnetostatics.inductance import inductance_is_magnetic_flux_over_current as _inductance_law
...
# in parallel
# TODO: create law and use it here.
