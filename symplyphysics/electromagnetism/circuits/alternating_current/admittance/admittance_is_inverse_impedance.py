...
Also see :ref:`Impedance definition <Impedance is resistance and reactance>`
...
def calculate_admittance(impedance_: Quantity) -> Quantity:
    solved = solve(law, admittance, dict=True)[0][admittance]
