...
from symplyphysics.reorganized.nuclear_physics.general import diffusion_equation_from_neutron_flux as diffusion_equation_law
from symplyphysics.reorganized.nuclear_physics.buckling import geometric_buckling_from_neutron_flux as buckling_law
