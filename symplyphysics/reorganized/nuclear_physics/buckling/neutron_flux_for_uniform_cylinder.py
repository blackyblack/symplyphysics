...
from symplyphysics.reorganized.nuclear_physics.buckling import geometric_buckling_from_neutron_flux
from symplyphysics.reorganized.nuclear_physics.buckling import neutron_flux_for_uniform_slab
