...
from symplyphysics.reorganized.thermodynamics.response_functions.thermal_expansion import volumetric_coefficient_of_thermal_expansion as coefficient_def
