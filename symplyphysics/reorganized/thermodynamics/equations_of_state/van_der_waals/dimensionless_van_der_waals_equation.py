...
from symplyphysics.reorganized.thermodynamics.equations_of_state.van_der_waals import critical_van_der_waals_molar_volume
from symplyphysics.reorganized.thermodynamics.equations_of_state.van_der_waals import critical_van_der_waals_pressure
from symplyphysics.reorganized.thermodynamics.equations_of_state.van_der_waals import critical_van_der_waals_temperature
from symplyphysics.reorganized.thermodynamics.equations_of_state.van_der_waals import reduced_van_der_waals_pressure as reduced_pressure_law
from symplyphysics.reorganized.thermodynamics.equations_of_state.van_der_waals import reduced_van_der_waals_temperature as reduced_temperature_law
from symplyphysics.reorganized.thermodynamics.equations_of_state.van_der_waals import reduced_van_der_waals_volume as reduced_volume_law
from symplyphysics.reorganized.thermodynamics.equations_of_state.van_der_waals import van_der_vaals_equation
...
_critical_molar_volume_expr = critical_van_der_waals_molar_volume.law.rhs.subs({
    critical_van_der_waals_molar_volume.excluded_volume_parameter: van_der_vaals_equation.excluded_volume_parameter,
})

_critical_temperature_expr = critical_van_der_waals_temperature.law.rhs.subs({
    critical_van_der_waals_temperature.attractive_forces_parameter: van_der_vaals_equation.attractive_forces_parameter,
    critical_van_der_waals_temperature.excluded_volume_parameter: van_der_vaals_equation.excluded_volume_parameter,
})
