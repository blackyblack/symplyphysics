...
from symplyphysics.reorganized.continuum_mechanics.fluid_mechanics.hydrostatics import hydrostatic_pressure_via_density_height_and_acceleration as pressure_law
...
# Horizontal vector
_vessel_acceleration_vector = CoordinateVector([acceleration, 0, 0], CARTESIAN)
