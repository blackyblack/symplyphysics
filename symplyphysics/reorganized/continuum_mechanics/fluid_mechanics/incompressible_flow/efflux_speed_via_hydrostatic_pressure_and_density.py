...
of the fluid's :ref:`hydrostatic pressure <Hydrostatic pressure via density and height>`
and density.
...
from symplyphysics.reorganized.continuum_mechanics.fluid_mechanics.hydrostatics import hydrostatic_pressure_via_density_and_height as pressure_law
from symplyphysics.reorganized.continuum_mechanics.fluid_mechanics.incompressible_flow import efflux_speed_via_height as velocity_law
