...
from symplyphysics.reorganized.optics.geometrical_optics.invariants import abbe_invariant_of_two_optical_environments_is_constant as abbe_conservation_law
...
law = Eq(
    -1 * medium_refraction_index / distance_to_object + lens_refraction_index / distance_to_image,
