...
from symplyphysics.reorganized.circuits.fundamentals import current_is_charge_derivative as charge_definition
from symplyphysics.reorganized.electromagnetism.electrostatics.capacitance import capacitance_from_charge_and_voltage as capacitance_definition
from symplyphysics.reorganized.circuits.direct_current.general import current_is_voltage_over_resistance as ohms_law
from symplyphysics.reorganized.circuits.fundamentals import sum_of_currents_through_junction_is_zero as kirchhoff_law
from symplyphysics.reorganized.circuits.fundamentals import sum_of_voltages_in_loop_is_zero as kirchhoff_law_2
from symplyphysics.reorganized.circuits.transient_analysis.serial_resistor_capacitor_circuit import time_constant_of_resistor_capacitor_circuit as time_constant_law
...
@validate_input(initial_voltage_=source_voltage, time_constant_=time_constant, time_=time)
@validate_output(capacitor_voltage)
def calculate_capacitor_voltage(initial_voltage_: Quantity, time_constant_: Quantity,
    time_: Quantity) -> Quantity:
    capacitor_voltage_expr = solve(law, capacitor_voltage, dict=True)[0][capacitor_voltage]
