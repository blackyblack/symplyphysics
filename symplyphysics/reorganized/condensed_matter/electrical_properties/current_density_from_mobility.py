...
from symplyphysics.reorganized.condensed_matter.electrical_properties import current_density_via_number_density_and_drift_velocity as density_velocity_law
from symplyphysics.reorganized.condensed_matter.electrical_properties import drift_velocity_of_charge_carriers as velocity_law
...
electrons_concentration = clone_as_symbol(symbols.number_density,
    display_symbol="n_e",
    display_latex="n_\\text{e}")
"""
Concentration (:symbols:`number_density`) of electrons.
"""

holes_concentration = clone_as_symbol(symbols.number_density,
    display_symbol="n_h",
    display_latex="n_\\text{h}")
"""
Concentration (:symbols:`number_density`) of holes.
"""

electrons_mobility = clone_as_symbol(symbols.mobility,
    display_symbol="mu_e",
    display_latex="\\mu_\\text{e}")
"""
:symbols:`mobility` of electrons.
"""

holes_mobility = clone_as_symbol(symbols.mobility,
    display_symbol="mu_h",
    display_latex="\\mu_\\text{h}")
"""
