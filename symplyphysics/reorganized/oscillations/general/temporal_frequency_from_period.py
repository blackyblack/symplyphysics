...
It is the inverse of period. See :ref:`Temporal frequency is number of events per unit time`
...
from symplyphysics.reorganized.oscillations.general import temporal_frequency_is_number_of_events_per_unit_time as frequency_def
