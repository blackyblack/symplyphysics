...
:ref:`Average angular speed is angular distance over time` for additional information.
...
from symplyphysics.reorganized.classical_mechanics.kinematics.rotational_motion import average_angular_speed_is_angular_distance_over_time as frequency_def
