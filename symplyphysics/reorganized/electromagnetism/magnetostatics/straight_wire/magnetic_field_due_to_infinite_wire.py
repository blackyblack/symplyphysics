...
from symplyphysics.reorganized.electromagnetism.magnetostatics.straight_wire import magnetic_induction_of_linear_conductor_of_finite_length as _finite_wire_law
