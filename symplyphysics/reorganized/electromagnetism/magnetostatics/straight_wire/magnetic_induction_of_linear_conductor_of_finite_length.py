...
from symplyphysics.reorganized.electromagnetism.magnetostatics.straight_wire import magnetic_field_due_to_constant_filamentary_current as _biot_savart_law
