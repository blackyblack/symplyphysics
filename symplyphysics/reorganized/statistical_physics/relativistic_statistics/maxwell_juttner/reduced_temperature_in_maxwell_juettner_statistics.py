...
Reduced temperature is a dimensionless quantity used in the :ref:`Maxwell—Jüttner distribution`
function. It depends on the temperature of the system, as well as on the mass of a particle of the
gas in question.
