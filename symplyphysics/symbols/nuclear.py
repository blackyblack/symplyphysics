...
multiplication_factor = SymbolNew("k", dimensionless)
"""
...
infinite_multiplication_factor = SymbolNew("k_inf", dimensionless, display_latex="k_\\infty")
"""
...
effective_multiplication_factor = SymbolNew("k_eff", dimensionless, display_latex="k_\\text{eff}")
"""
...
neutron_diffusion_area = SymbolNew("L^2", units.area)
"""
...
neutron_flux = SymbolNew("Phi", 1 / (units.area * units.time), display_latex="\\Phi")
"""
...
material_buckling = SymbolNew("B_m^2", 1 / units.area, display_latex="B_\\text{m}^2")
"""
...
fast_non_leakage_probability = SymbolNew("P_FNL", dimensionless, display_latex="P_\\text{FNL}")
"""
...
thermal_non_leakage_probability = SymbolNew("P_TNL", dimensionless, display_latex="P_\\text{TNL}")
"""
...
fast_fission_factor = SymbolNew("epsilon", dimensionless, display_latex="\\varepsilon")
"""
...
resonance_escape_probability = SymbolNew("p", dimensionless)
"""
...
fast_absorption_fission_probability = SymbolNew("P_FAF", dimensionless, display_latex="P_\\text{FAF}")
"""
...
thermal_absorption_fission_probability = SymbolNew("P_TAF", dimensionless, display_latex="P_\\text{TAF}")
"""
...
thermal_utilization_factor = SymbolNew("f", dimensionless)
"""
...
fast_utilization = SymbolNew("u_f", dimensionless, display_latex="u_\\text{f}")
"""
...
half_life = SymbolNew("t_1/2", units.time, display_latex="t_{1/2}")
"""
...
macroscopic_cross_section = SymbolNew("Sigma", 1 / units.length, display_latex="\\Sigma")
"""
...
neutron_diffusion_coefficient = SymbolNew("D", units.length)
"""
...
migration_area = SymbolNew("M^2", units.area)
"""
...
reproduction_factor = SymbolNew("eta", dimensionless, display_latex="\\eta")
"""
