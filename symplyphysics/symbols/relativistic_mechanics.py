...
lorentz_factor = Symbol("gamma", dimensionless, display_latex="\\gamma")
"""
...
spacetime_interval = Symbol("s", units.length)
"""
...
proper_time = Symbol("tau", units.time, display_latex="\\tau")
"""
...
rest_mass = Symbol("m_0", units.mass)
"""
...
proper_length = Symbol("l_0", units.length)
"""
...
relativistic_mass = Symbol("m", units.mass)
"""
