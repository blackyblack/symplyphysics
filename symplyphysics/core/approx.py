...
def approx_equal_quantities(lhs: Quantity,
    ...
    *,
    ...
    if not approx_equal_numbers(
            N(im(lhs.scale_factor)), N(im(rhs_quantity.scale_factor)),
            relative_tolerance=tolerance, absolute_tolerance=absolute_tolerance):
        return False
...
def assert_equal(lhs: Expr | float,
    ...
    *,
    ...
    assert approx_equal_quantities(
        lhs_quantity, rhs_quantity, tolerance=tolerance, absolute_tolerance=absolute_tolerance, dimension=dimension
...
def assert_equal_vectors(
    ...
    *,
    ...
    for l, r in zip(lhs.components, rhs.components, strict=True):
        assert_equal(l, r, tolerance=tolerance, absolute_tolerance=absolute_tolerance, dimension=dimension)
