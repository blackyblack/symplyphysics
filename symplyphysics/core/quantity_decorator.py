...
from .symbols.symbols import DimensionSymbol, DimensionSymbolNew, FunctionNew, Symbol, SymbolIndexedNew
...
_UnitType: TypeAlias = Dimension | Symbol | FunctionNew | SymbolIndexedNew
...
def validate_output(
    expected_unit: Dimension | Symbol | FunctionNew | SymbolIndexedNew
