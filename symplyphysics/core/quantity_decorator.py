...
from .symbols.symbols import DimensionSymbol, DimensionSymbolNew, Function, Symbol, SymbolIndexedNew
...
def validate_output(
    expected_unit: Dimension | Symbol | Function | SymbolIndexedNew
