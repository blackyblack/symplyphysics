...
from .symbols.symbols import DimensionSymbol, DimensionSymbolNew, FunctionNew, SymbolNew, SymbolIndexedNew
...
_UnitType: TypeAlias = Dimension | SymbolNew | FunctionNew | SymbolIndexedNew
...
def validate_output(
    expected_unit: Dimension | SymbolNew | FunctionNew | SymbolIndexedNew
