...
from symplyphysics.continuum_mechanics.elasticity.stress import bulk_stress_is_bulk_modulus_times_strain as _bulk_law
from symplyphysics.continuum_mechanics.acoustic_waves import speed_of_sound_via_bulk_modulus_and_density as _sound_speed_law
