...
from symplyphysics.laws.classical_mechanics.kinematics.rotational_motion import displacement_is_angular_displacement_cross_radius as _linear_displacement_law
