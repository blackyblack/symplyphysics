...
from symplyphysics.laws.classical_mechanics.kinematics.projectile_motion import maximum_movement_time_of_a_body_thrown_at_an_angle_to_horizon as time_law
