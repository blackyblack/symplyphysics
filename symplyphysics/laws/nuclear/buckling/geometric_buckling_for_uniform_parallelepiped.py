...
geometric_buckling_parallelepiped_squared = (
    parallelepiped_flux.width_constant**2 +
    parallelepiped_flux.length_constant**2 +
    parallelepiped_flux.height_constant**2)
...
def calculate_geometric_buckling_squared(
        parallelepiped_width_: Quantity, parallelepiped_length_: Quantity,
        parallelepiped_height_: Quantity) -> Quantity:
