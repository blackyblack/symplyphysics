...
geometric_buckling_squared = symbols.geometric_buckling
"""
...
_buckling_eq1 = buckling_law.law.subs({
    buckling_law.geometric_buckling: geometric_buckling_squared,
...
_derived_geometric_buckling_squared = solve(_derived_law, (geometric_buckling_squared,
