...
law = Eq(
    ...
    ((neutrons_per_fission / effective_multiplication_factor) *
     macroscopic_fission_cross_section - macroscopic_absorption_cross_section) /
...
def calculate_buckling(neutrons_per_fission_: float,
    ...
    result_expr = result_buckling_expr.subs({
        ...
        effective_multiplication_factor:
            effective_multiplication_factor_,
        macroscopic_fission_cross_section:
