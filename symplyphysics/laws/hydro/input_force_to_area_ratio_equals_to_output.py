...
input_force = clone_symbol(symbols.force, display_symbol="F_in", display_latex="F_\\text{in}")
input_area = Symbol("input_area", units.area)
output_force = clone_symbol(symbols.force, display_symbol="F_out", display_latex="F_\\text{out}")
