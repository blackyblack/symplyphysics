...
law = Eq(charge_carriers_concentration, sqrt(density_of_states_in_conduction_band * density_of_states_in_valence_band) * exp(-band_gap/(2 * boltzmann * temperature)))
...
@validate_input(density_of_states_in_conduction_band_=density_of_states_in_conduction_band, density_of_states_in_valence_band_=density_of_states_in_valence_band, band_gap_=band_gap, temperature_=temperature)
@validate_output(charge_carriers_concentration)
def calculate_concentration(density_of_states_in_conduction_band_: Quantity, density_of_states_in_valence_band_: Quantity, band_gap_: Quantity, temperature_: Quantity) -> Quantity:
    result_expr = solve(law, charge_carriers_concentration, dict=True)[0][charge_carriers_concentration]
