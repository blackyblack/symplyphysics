...
from symplyphysics.laws.waves.wave_propagation import (
    wavelength_from_phase_speed_and_period as wavelength_law,
)
from symplyphysics.laws.waves.stretched_string import wavelength_of_standing_wave_in_string_with_fixed_ends as resonance_law
