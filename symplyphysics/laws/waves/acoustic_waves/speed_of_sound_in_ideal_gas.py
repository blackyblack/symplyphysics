...
from symplyphysics.laws.waves.acoustic_waves import isentropic_speed_of_sound_via_pressure_derivative as sound_law
from symplyphysics.laws.thermodynamics.equations_of_state.ideal_gas import pressure_and_volume_in_adiabatic_process as adiabate_law
