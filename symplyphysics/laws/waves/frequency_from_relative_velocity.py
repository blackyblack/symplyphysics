...
## speed of source related to observer is used for Doppler effect calculating.

# Law: fo = fs * sqrt((c - vo)/(c + v)), where
## fo is observed frequency,
## fs is source wave frequency,
## v is velocity of source related to observer,
## c is speed of light.

# Conditions:
## Positive velocity direction means source moving towards observer.
...
law = Eq(observed_frequency, real_frequency * sqrt((c - source_velocity) / (c + source_velocity)))
