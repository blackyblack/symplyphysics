...
law = Eq(average_square_velocity, 3 * units.boltzmann_constant * temperature_in_gas / mass_of_molecule)
...
def calculate_average_square_velocity(temperature_in_gas_: Quantity, mass_of_molecule_: Quantity) -> Quantity:
    result_average_square_velocity = solve(law, average_square_velocity, dict=True)[0][average_square_velocity]
    result_expr = result_average_square_velocity.subs({temperature_in_gas: temperature_in_gas_, mass_of_molecule: mass_of_molecule_})
