...
law = Eq(average_square_velocity, 3 * units.boltzmann_constant * temperature_in_gas / mass_of_atom)
...
def calculate_rsm_velocity(temperature_in_gas_: Quantity,
    ...
    result_rsm_velocity = solve(law, average_square_velocity, dict=True)[0][average_square_velocity]
