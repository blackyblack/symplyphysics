...
@validate_input(surface_tension_of_the_liquid_=surface_tension_of_the_liquid, radius_of_curvature_=radius_of_curvature)
@validate_output(laplas_pressure)
def calculate_laplas_pressure(surface_tension_of_the_liquid_: Quantity, radius_of_curvature_: Quantity) -> Quantity:
    solved = solve(law, laplas_pressure, dict=True)[0][laplas_pressure]
    result_expr = solved.subs({surface_tension_of_the_liquid: surface_tension_of_the_liquid_, radius_of_curvature: radius_of_curvature_})
