...
laplase_pressure = Symbol("laplase_pressure", units.pressure)

law = Eq(laplase_pressure, 2 * surface_tension_of_the_liquid / radius_of_curvature)
...
@validate_output(laplase_pressure)
def calculate_laplase_pressure(surface_tension_of_the_liquid_: Quantity,
    radius_of_curvature_: Quantity) -> Quantity:
    solved = solve(law, laplase_pressure, dict=True)[0][laplase_pressure]
