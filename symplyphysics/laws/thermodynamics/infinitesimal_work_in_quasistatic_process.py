...
## dV - infinitesimal increment of volume of the system

# Note:
## - `delta` means that the increment is an inexact (path-dependent) differential.
## - `d` means that the increment is an exact (path-independent) differential.
