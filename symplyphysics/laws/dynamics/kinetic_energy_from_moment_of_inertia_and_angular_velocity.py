...
object_inertia_moment = Symbol("object_inertia_moment",
...
@validate_input_symbols(inertia_moment_=object_inertia_moment,
                        angular_velocity_=angular_velocity)
@validate_output_symbol(kinetic_energy)
def calculate_energy(inertia_moment_: Quantity,
                     angular_velocity_: Quantity) -> Quantity:
    result_energy_expr = solve(law, kinetic_energy,
                               dict=True)[0][kinetic_energy]
