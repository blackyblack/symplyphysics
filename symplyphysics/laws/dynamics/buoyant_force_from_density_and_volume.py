...
law = Eq(
    force_buoyant,
    -1 * fluid_density * units.acceleration_due_to_gravity * displaced_volume)
...
@validate_input_symbols(fluid_density_=fluid_density,
                        displaced_volume_=displaced_volume)
@validate_output_symbol(force_buoyant)
def calculate_force_buoyant(fluid_density_: Quantity,
                            displaced_volume_: Quantity) -> Quantity:
