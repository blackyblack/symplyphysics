...
action_force = clone_symbol(symbols.force, display_symbol="F_12", display_latex="F_{12}")
"""
The projection of the :attr:`~symplyphysics.symbols.force` that the first body exerts on the second body.
"""

reaction_force = clone_symbol(symbols.force, display_symbol="F_21", display_latex="F_{21}")
"""
