...
law = Eq((1 / focus_distance),
         (1 / distance_to_object) + (1 / distance_to_image))
...
@validate_input_symbols(object_distance_=distance_to_object,
                        image_distance_=distance_to_image)
@validate_output_symbol(focus_distance)
def calculate_focus(object_distance_: Quantity,
                    image_distance_: Quantity) -> Quantity:
