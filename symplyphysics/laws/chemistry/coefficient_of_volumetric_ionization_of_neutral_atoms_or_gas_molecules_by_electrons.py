...
coefficient_of_volumetric_ionization = Symbol("coefficient_of_volumetric_ionization", 1 / units.length)
...
law = Eq(coefficient_of_volumetric_ionization, first_constant_of_gas * pressure * exp(-second_constant_of_gas * pressure / electric_intensity))
...
def calculate_coefficient_of_volumetric_ionization(first_constant_of_gas_: Quantity,
    second_constant_of_gas_: Quantity, pressure_: Quantity, electric_intensity_: Quantity) -> Quantity:
