...
mass_of_target_atom = Symbol("mass_of_target_atom", units.mass / units.amount_of_substance)
...
law = Eq(etching_rate, ion_current_density * mass_of_target_atom * sputtering_coefficient / (elementary_charge * target_density * avogadro_constant))


@validate_input(ion_current_density_=ion_current_density,
                mass_of_target_atom_=mass_of_target_atom,
                sputtering_coefficient_=sputtering_coefficient,
                target_density_=target_density)
@validate_output(etching_rate)
def calculate_etching_rate(ion_current_density_: Quantity, mass_of_target_atom_: Quantity,
    ...
    result_expr = result_expr.subs({
        ...
        mass_of_target_atom: mass_of_target_atom_,
