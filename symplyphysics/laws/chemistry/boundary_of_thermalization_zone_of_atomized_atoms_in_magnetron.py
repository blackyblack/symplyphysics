...
law = Eq(boundary_of_thermalization_zone, number_of_collisions_of_atoms * free_path_length)
...
@validate_input(number_of_collisions_of_atoms_=number_of_collisions_of_atoms,
    free_path_length_=free_path_length)
@validate_output(boundary_of_thermalization_zone)
def calculate_boundary_of_thermalization_zone(number_of_collisions_of_atoms_: float,
    ...
    result_expr = result_expr.subs({
        number_of_collisions_of_atoms: number_of_collisions_of_atoms_,
