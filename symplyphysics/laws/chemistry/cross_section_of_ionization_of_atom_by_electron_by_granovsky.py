...
effective_cross_section = clone_as_symbol(symbols.cross_section,
    display_symbol="sigma_eff",
    display_latex="\\sigma_\\text{eff}")
"""
Effective :symbols:`cross_section` of ionization of particles.
"""

ionization_energy = clone_as_symbol(symbols.energy,
    display_symbol="sigma_i",
    display_latex="\\sigma_\\text{i}")
"""
...
maximum_cross_section = clone_as_symbol(symbols.cross_section,
    display_symbol="sigma_max",
    display_latex="\\sigma_\\text{max}")
"""
Maximum :symbols:`cross_section` of ionization.
"""

maximum_electron_energy = clone_as_symbol(symbols.energy,
    display_symbol="E_max",
    display_latex="E_\\text{max}")
"""
