...
from symplyphysics.laws.statistical_physics.classical_statistics.maxwell_boltzmann import maxwell_boltzmann_velocity_component_distribution as _velocity_component_distribution
