...
law = Eq(filter_order, log(band_stop_distortion / bandwidth_distortion) / log(band_stop_frequency / cutoff_frequency))
...
def calculate_order(bandwidth_distortion_: float, band_stop_distortion_: float, band_stop_frequency_: Quantity,
