...
law = Eq(
    Matrix([input_reflected_wave, output_reflected_wave]),
    Matrix([[reflection_coefficient, reverse_transmission_ratio],
    [transmission_ratio, output_reflection_coefficient]]) * Matrix([input_wave, output_wave]))
...
@validate_input(input_reflected_wave_=input_reflected_wave,
    output_reflected_wave_=output_reflected_wave)
