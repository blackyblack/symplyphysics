...
from symplyphysics.laws.electricity.circuits.transmission_lines import transmission_matrix_of_pi_type_circuit as matrix_circuit_law

## Description
## The pi-type circuit consists of the first impedance connected in parallel, the third impedance connected in series, and the
