...
expression_A = ((1 + reflection_coefficient) * (1 - output_reflection_coefficient) +
    reverse_transmission_ratio * transmission_ratio) / (2 * transmission_ratio)
expression_B = characteristic_resistance * ((1 + reflection_coefficient) *
    (1 + output_reflection_coefficient) - reverse_transmission_ratio * transmission_ratio) / (2 *
    transmission_ratio)
expression_C = (1 / characteristic_resistance) * ((1 - reflection_coefficient) *
    (1 - output_reflection_coefficient) - reverse_transmission_ratio * transmission_ratio) / (2 *
    transmission_ratio)
expression_D = ((1 - reflection_coefficient) * (1 + output_reflection_coefficient) +
    reverse_transmission_ratio * transmission_ratio) / (2 * transmission_ratio)
