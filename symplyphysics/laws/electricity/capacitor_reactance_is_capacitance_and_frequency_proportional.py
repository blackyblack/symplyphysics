...
capacitor_reactance = Symbol("capacitor_reactance", units.impedance)
...
law = Eq(capacitor_reactance, -I / (circular_frequency * capacitor_capacitance))
...
@validate_output(capacitor_reactance)
def calculate_reactance(capacitance_: Quantity, circular_frequency_: Quantity) -> Quantity:
    result_reactance_expr = solve(law, capacitor_reactance, dict=True)[0][capacitor_reactance]
    result_expr = result_reactance_expr.subs({
