...
## Law is: Matrix([[A, B], [C, D]]) = Matrix([[1 + Z1 / Z3, Z1 + Z2 + Z1 * Z2 / Z3], [1 / Z3, 1 + Z2 / Z3]]), where
...
matrix_derived_1[series_law.parameter_conductance] = matrix_derived_1[series_law.parameter_conductance].scale_factor
...
matrix_derived_3[parallel_law.parameter_impedance] = matrix_derived_3[parallel_law.parameter_impedance].scale_factor
...
matrix_derived_2[series_law.parameter_conductance] = matrix_derived_2[series_law.parameter_conductance].scale_factor
