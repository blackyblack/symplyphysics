...
## Law is: Wef / h = W / h + (1.25 * t / (pi * h)) * (1 + ln(4 * pi * W / t)), where
...
# Conditions:
# - the thickness of the substrate of the microstrip line should be greater than or equal to the width * 2 * pi.
