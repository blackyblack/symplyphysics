...
own_quality_factor = Symbol("own_quality_factor", dimensionless)
external_circuit_quality_factor = Symbol("external_circuit_quality_factor", dimensionless)

law = Eq(coupling_parameter, own_quality_factor / external_circuit_quality_factor)
...
@validate_input(own_quality_factor_=own_quality_factor, external_circuit_quality_factor_=external_circuit_quality_factor)
@validate_output(coupling_parameter)
def calculate_coupling_parameter(own_quality_factor_: float,
    external_circuit_quality_factor_: float) -> float:
    result_expr = solve(law, coupling_parameter, dict=True)[0][coupling_parameter]
    result_expr = result_expr.subs({
        own_quality_factor: own_quality_factor_,
