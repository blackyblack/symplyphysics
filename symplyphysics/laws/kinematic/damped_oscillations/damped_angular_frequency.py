...
# Description
## An underdamped oscillator performs oscillations with a frequency proportional
## to that of an undamped oscillator, i.e. to the frequency of an oscillator when
## there is no damping force in the system.
...
law = Eq(
    ...
    undamped_angular_frequency * sqrt(1 - damping_ratio**2)
)
